    ...
    def _create_default_config(self):
        ...
        default_queries = {
            "test_queries": [
                ...
                "Show me model drift for the ensemble",
                "What are the top 5 important features?",
                "Compare ensemble vs base models on all metrics",
                "Why is the ensemble performing worse than XGBoost?",
                "Show me all active models",
                "Has model performance degraded over the last quarter?",
                "Compare these models",
                "Show me performance for NRx models",
                ...
                "Why is ensemble underperforming?"
            ]
        }
